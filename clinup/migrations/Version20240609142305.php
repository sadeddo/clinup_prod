 ...
 */
final class Version20240609142305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE icalres (id INT AUTO_INCREMENT NOT NULL, logement_id INT DEFAULT NULL, dt_start VARCHAR(255) DEFAULT NULL, dt_end VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, INDEX IDX_5E73BEA058ABF955 (logement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE logement (id INT AUTO_INCREMENT NOT NULL, hote_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(350) NOT NULL, complet_adresse VARCHAR(350) DEFAULT NULL, surface VARCHAR(255) NOT NULL, nbr_chambre INT NOT NULL, nbr_bain INT NOT NULL, description LONGTEXT DEFAULT NULL, airbnb VARCHAR(255) DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, INDEX IDX_F0FD4457453D3D6F (hote_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
